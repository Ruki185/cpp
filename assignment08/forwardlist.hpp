...
class ForwardList
{
    ...
    struct Node
    {
        ...
        Node(const ???& data, Node* next) : data{data}, next{next} {}
...
public:
    ...
    void push_front(const ???& value){ /* ToDo */ }
    ...
    Iterator insert_after(Iterator pos, ??? value){ /* ToDo */ }
